...
if os.path.exists(matpath )==False:  # Make the directory for figures
    os.makedirs(matpath)
savemat(matpath+"phase_data_sim3.mat", {'theta':theta, 'h':h, 'fs':1/h})
#%% plot phase
...
ax.plot([1000, 1000], ylims, 'm--', linewidth=3, alpha=0.4)
ax.plot([2000, 2000], ylims, 'm--', linewidth=3, alpha=0.4)
ax.set_ylim(ylims)
